...
**Không lặp lại chi tiết ở đây** — xem đầy đủ tại [admin-nutrition-management-api.md](./admin-nutrition-management-api.md) mục _Chất dinh dưỡng_.
